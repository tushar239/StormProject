...
public class WordCountTopology {
    ...
    static class WordSpout extends BaseRichSpout {
        ...
        public void nextTuple() {
            ...
            collector.emit(new Values(wordList[nextInt]/*, new Person("Tushar")*/));
        }
        ...
        public void declareOutputFields(
            ...
            outputFieldsDeclarer.declare(new Fields("word"/*, "person"*/));
        }
    }
    ...
    static class CountBolt extends BaseRichBolt {
        ...
        public void execute(Tuple tuple) {
            System.out.println("CountBolt TaskId: " + topologyContext.getThisTaskId());
            //**************************************************
...
//            System.out.println("Person name: " + person.getName());
    ...
    static class ReportBolt extends BaseRichBolt {
        ...
        @Override
        public void execute(Tuple tuple) {
            System.out.println("ReportBolt TaskId: " + topologyContext.getThisTaskId());
            ...
            System.out.println("WordCountTopology"+ word + "|" + Long.toString(count));
    ...
    public static void main(String[] args) throws Exception {
        ...
        BoltDeclarer countBolt = builder.setBolt("count-bolt", new CountBolt(), 15);
        countBolt.fieldsGrouping("word-spout", new Fields("word"));

        // attach the report bolt using global grouping - parallelism of 1
        //***************************************************
        // BEGIN YOUR CODE - Part 3-of-3

        builder.setBolt("report-bolt", new ReportBolt(), 1).globalGrouping("count-bolt");//.setNumTasks(4);
